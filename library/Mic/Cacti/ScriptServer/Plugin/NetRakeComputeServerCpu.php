...
/**
 * Mic_Cacti_ScriptServer_Plugin_NetRakeComputeServerCpu
 *
 * @category  Mic
 * @package   Mic_Cacti
 */
class Mic_Cacti_ScriptServer_Plugin_NetRakeComputeServerCpu extends Mic_Cacti_ScriptServer_Plugin
{
